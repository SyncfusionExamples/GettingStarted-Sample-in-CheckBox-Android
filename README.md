...
This demo describes how to start with CheckBox control in Xamarin.Android. In this project, the sample check box is prepared in Xamarin.Android.

## Syncfusion Controls

This project uses the following Syncfusion controls:

* [SfCheckBox](https://www.syncfusion.com/xamarin-android-ui-controls/checkbox) - To show the CheckBox.

## Screenshots
<img src="Images/CheckBoxAndroid.png"  Width="250"/> 
